...
We kept the tables as simple as possible so that space could be optimised.
...
The Topic and Post also contained o foregin key to the person who created the associated post/topic.
The Post contained a message and a timePosted variable. This was important to include as it indicated which topic was posted into most recently, which showed on the forum view page. It would also aid in ordering the posts in the topics, so the are in the correct order.

The PostLikes contained a foreign key to the person and the post. This is because there can be many likes to 1 post. 



Hello \texttt{title} I'm bold
